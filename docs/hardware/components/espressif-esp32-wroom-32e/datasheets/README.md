# ESP32-WROOM-32E / 32UE Official Datasheets
...
- **esp32_hardware_design_guidelines_en.pdf** - Hardware Design Guidelines
...
- **esp32_technical_reference_manual_en.pdf** - Technical Reference Manual
  - Source: https://www.espressif.com/sites/default/files/documentation/esp32_technical_reference_manual_en.pdf
  - Contains: Complete peripheral register descriptions, detailed functional descriptions
...
- **Module Datasheet:** Pin assignments, electrical specs, antenna design, mechanical dimensions
- **SoC Datasheet:** Chip capabilities, peripheral features, memory maps
- **Hardware Guidelines:** PCB layout, RF design best practices, component selection
- **Technical Manual:** Register-level programming, peripheral configuration, timing diagrams

For quick reference and HaloSense-specific notes, see the main component documentation: [../README.md](../README.md)
